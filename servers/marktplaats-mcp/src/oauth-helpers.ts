...
<title>Connect ${clientName} to marktplaats-mcp</title>
<style>
...
<body>
<main>
<h1>Connect to marktplaats-mcp</h1>
<p><strong>${clientName}</strong> is requesting access to the marktplaats-mcp server.</p>
${errorBanner}
