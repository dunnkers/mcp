...
// Checked first thing in the fetch handler, before OAuth/routing/any real
// work, so a flood of requests gets a cheap 429 instead of paying for a KV
// lookup (OAuth token validation) or Marktplaats fetch on every hit. This is
